package com.krianapps.warkoppos.mlt;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.krianapps.warkoppos.mlt.R.layout.activity_main);

        webView = findViewById(com.krianapps.warkoppos.mlt.R.id.webView);
        progress = findViewById(com.krianapps.warkoppos.mlt.R.id.progress);
